...
TEST(ByteSetTrieTest, trietest)
{
    ...
    value = ByteSet<BYTE>("0123456789012345678901234567890123456789Very_Long", UTF8);
    btt.store(key, value);

    key = ByteSet<NIBBLE>("key2bb", UTF8);
    value = ByteSet<BYTE>("aval3", UTF8);
    btt.store(key, value);

    key = ByteSet<NIBBLE>("key2", UTF8);
    value = ByteSet<BYTE>("short", UTF8);
    btt.store(key, value);
    ...
    value = ByteSet<BYTE>("abcd", UTF8);
    btt.store(key, value);

    key = ByteSet<NIBBLE>("abc", UTF8);
    value = ByteSet<BYTE>("abc", UTF8);
    btt.store(key, value);
